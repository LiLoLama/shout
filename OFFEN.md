...
- [ ] **iOS-Restposten**: der Siri-/Kurzbefehl-Titel in `DictateIntent.swift` ist eine `LocalizedStringResource` und bräuchte für eine Übersetzung einen String-Katalog (`.xcstrings`) — bleibt vorerst deutsch. Nur im Simulator gebaut, nicht auf dem Gerät geprüft.
