...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Es läuft bereits eine Aufnahme."] = "A recording is already running.",
        ...
        ["Es kommt kein Ton an. Prüfe, ob die gewählte Quelle wirklich etwas ausgibt."] = "No audio is arriving. Check that the chosen source is actually producing sound.",
